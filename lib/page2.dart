      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          icon: GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => const TrainingDetailed2()));
            },
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          GestureDetector(
            onTap: () {
              Navigator.push(context, MaterialPageRoute(builder: (context) => const PreRequirements2()));
            },
            child: Container(
              width: 324,
              height: 50,
